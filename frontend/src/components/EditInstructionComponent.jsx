        ...
        <div className="main-content">
            ...
            <form>
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingInput1" placeholder="Протокол засідання кафедри №" value={"1234-5678"}/>
                ...
                <button className='add-user-button mt-3 mb-3' onClick={() => addUser()}>Виправити доручення</button>
                </form>
